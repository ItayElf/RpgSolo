      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SelectableText(
              "The players encounter ${encounter.encounter}${encounter.description != "" ? " ${encounter.description}" : ""} in the ${encounter.locationType.name}. ${encounter.benefit.toTitleCase(true)}",
